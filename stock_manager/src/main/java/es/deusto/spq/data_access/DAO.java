...
public class DAO {
	...
	// Meter varios datos a la base de datos
	 ...
	 public void meter_datos() {
		...
		Articulo manzana = new Articulo("manzana", new Date(04 / 03 / 120), 1.20f, 400, "rica manzana", 0.95f,
				Categoria.FRUTA);
		Articulo lechuga = new Articulo("lechuga", new Date(04 / 03 / 120), 1.20f, 400, "rica lechuga", 0.95f,
				Categoria.VEGETAL);
		Articulo fresa = new Articulo("pimiento", new Date(04 / 03 / 120), 1.20f, 400, "rica fresa", 0.95f,
				Categoria.VEGETAL);
		Articulo calabaza = new Articulo("lechuga", new Date(04 / 03 / 120), 1.20f, 400, "rica calabza", 0.95f,
				Categoria.VEGETAL);
		Articulo pimiento = new Articulo("lechuga", new Date(04 / 03 / 120), 1.20f, 400, "rico pimiento", 0.95f,
				Categoria.VEGETAL);
		Articulo a1 = new Articulo("coliflor", new Date(04 / 03 / 120), 1.20f, 400, "rica coliflor", 1.05f,
				Categoria.FRUTA);
		Articulo a2 = new Articulo("pan", new Date(04 / 03 / 120), 1.20f, 400, "rica pan", 1.05f, Categoria.FRUTA);
		Articulo a3 = new Articulo("agua", new Date(04 / 03 / 120), 1.20f, 400, "rica agua", 1.05f, Categoria.BEBIDA);
		Articulo a4 = new Articulo("Mandarina", new Date(04 / 03 / 120), 1.20f, 400, "rica mandarina", 1.05f,
