...
public class CrearArticulo extends JFrame {
	...
	public CrearArticulo() {
		...
		JLabel imagen = new JLabel("Categoria:");
		...
		aceptar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				float o = Float.parseFloat(ofer);
				String cat = tcategoria.getText();
				Categoria c = Categoria.valueOf(cat);
				String im = timagen.getText();
//				
				Articulo a = new Articulo(nom, date, p, s, des, o, c, im);
				DAO dao = new DAO();
				dao.store(a);
